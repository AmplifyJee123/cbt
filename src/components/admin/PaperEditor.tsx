...
interface Section {
  id: string;
  name: string;
  type: 'mcq-single' | 'mcq-multiple' | 'numerical' | 'matching';
  marks: number;
  negative: number;
  questions: Question[];
}
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={(e) => setPaperDetails(prev => ({ ...prev, title: e.target.value }))}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setPaperDetails(prev => ({ ...prev, subject: e.target.value }))}
              className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setPaperDetails(prev => ({ ...prev, duration: parseInt(e.target.value) }))}
              className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setPaperDetails(prev => ({ ...prev, instructions: e.target.value }))}
              className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              rows={4}
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setPaperDetails(prev => ({
                        ...prev,
                        sections: prev.sections.map(s => 
                          s.id === section.id ? { ...s, marks: parseInt(e.target.value) } : s
                        )
                      }));
                    }}
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setPaperDetails(prev => ({
                        ...prev,
                        sections: prev.sections.map(s => 
                          s.id === section.id ? { ...s, negative: parseInt(e.target.value) } : s
                        )
                      }));
                    }}
                    className="w-20 px-3 py-1.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="space-y-4">
              {section.questions.map((question, qIndex) => (
                <div key={question.id} className="border border-gray-100 rounded-lg p-4 bg-gray-50">
                  ...
                  {(section.type === 'mcq-single' || section.type === 'mcq-multiple') && (
                    <div className="space-y-2">
                      {question.options?.map((option, optIndex) => (
                        <div key={optIndex} className="flex items-center gap-2">
                          <input
                            type={section.type === 'mcq-single' ? 'radio' : 'checkbox'}
                            checked={
                                        ...
                                        questions: s.questions.map(q =>
                                          q.id === question.id 
                                            ? section.type === 'mcq-single'
                                              ...
                                              : {
                                                  ...q,
                                                  correctOptions: q.correctOptions?.includes(optIndex)
                                                    ? q.correctOptions.filter(i => i !== optIndex)
                            ...
                            sections: prev.sections.map(s => 
                              s.id === section.id 
                                ? {
                                    ...
                                    questions: s.questions.map(q =>
                                      q.id === question.id 
                                        ? { ...q, correctAnswer: parseInt(e.target.value) }
                                        : q
                                    )
                                  }
                                : s
                  ...
                  {section.type === 'matching' && (
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-medium text-gray-700 mb-2">List I</h4>
                      ...
                      <div>
                        <h4 className="font-medium text-gray-700 mb-2">List II</h4>
                      ...
                      <div className="col-span-2">
                        <h4 className="font-medium text-gray-700 mb-2">Correct Matches</h4>
                        <div className="grid grid-cols-4 gap-4">
                          {['P', 'Q', 'R', 'S'].map((item) => (
                            <div key={item}>
                              <label className="block text-sm text-gray-600 mb-1">{item} matches with:</label>
                              <select
