...
interface AuthScreenProps {
  onAuthenticate: (formData: any) => void;
  userData: {
    name: string;
    rollNo: string;
...
const AuthScreen: React.FC<AuthScreenProps> = ({ onAuthenticate, userData }) => {
  ...
  // Auto-fill roll number if available
  useEffect(() => {
    if (userData.rollNo) {
      ...
      <div className="w-full px-4 py-3 bg-gradient-to-r from-blue-800 to-blue-700 text-white shadow-md">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center">
          <div className="flex flex-col space-y-1 pl-2">
            ...
            <div className="text-2xl md:text-3xl font-bold tracking-tight">C001</div>
          </div>
      ...
      <div className="flex-1 w-full max-w-md px-6 py-12 flex flex-col items-center justify-center">
        ...
        >
          <div className="w-full px-6 py-4 bg-blue-600 text-white">
            <h2 className="text-xl font-semibold tracking-tight">Candidate Login</h2>
            <p className="text-sm text-blue-100 mt-1">Enter your credentials to continue</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            {/* Password/DOB Input */}
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700 block">Password (Date of Birth)</label>
              <div className="flex items-center border rounded-lg overflow-hidden transition-all focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
                <div className="px-4 py-3 bg-gray-50 text-gray-500 border-r">
                  <LockKeyhole size={20} />
                </div>
              ...
              <p className="text-xs text-gray-500 mt-1 pl-1">
                Enter your date of birth in DD-MM-YYYY format (e.g., 01-05-2000)
              </p>
            </div>
