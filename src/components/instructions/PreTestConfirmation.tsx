...
import { CheckCircle, AlertTriangle, Fingerprint, Laptop, Wifi, Clock } from 'lucide-react';

interface PreTestConfirmationProps {
...
const PreTestConfirmation: React.FC<PreTestConfirmationProps> = ({
  acceptedTerms,
  setAcceptedTerms,
  userData
}) => {
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-200 transform transition-all duration-300 hover:shadow-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
              ...
              <span className="text-gray-900 font-medium">{userData.rollNo}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-200 transform transition-all duration-300 hover:shadow-lg">
          ...
          <ul className="space-y-4">
            <li className="flex items-start p-3 bg-green-50 rounded-lg border border-green-100">
              ...
              <div>
                <p className="font-medium text-gray-800">Stable Internet Connection</p>
            ...
            <li className="flex items-start p-3 bg-green-50 rounded-lg border border-green-100">
              ...
              <div>
                <p className="font-medium text-gray-800">Device Charged & Ready</p>
                <p className="text-sm text-gray-600 mt-1">
                  Your device should be fully charged or connected to a power source.
                </p>
              </div>
            </li>
            <li className="flex items-start p-3 bg-green-50 rounded-lg border border-green-100">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  You will have 3 hours (180 minutes) to complete the test. Plan your time accordingly.
                </p>
              </div>
            </li>
          </ul>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-amber-700 text-sm mt-2">
                Once you start the test, you will not be able to pause or restart it. 
                The timer will continue even if you close your browser or lose connection.
                Switching tabs or minimizing the browser window may result in warnings. 
                After three warnings, your test may be automatically submitted.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-md">
          <div className="flex items-start">
            ...
            <label htmlFor="terms-accept" className="text-sm text-gray-700">
              I confirm that I have read and understood the test instructions. I agree to abide by the rules
              and confirm that I am ready to begin the test. I understand that the test cannot
              be paused once started, and I will not use any unfair means during the test.
            </label>
          </div>
